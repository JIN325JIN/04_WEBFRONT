...
//아이디가 test1-1인 요소를 얻어와 test1a변수 저장 
...
test1a.onclick= function(){
  alert("고전 이벤트 모델 확인 버튼 클릭 됨");
};

//고전이벤트 모델 제거 
//#test1-2버튼 클릭시
//#test1-1dml onclick 이벤트 리스너의 이벤트핸들러 제거하기
document.querySelector("#test1-2").onclick=function(){
  //기존 onclick의 이벤트 핸들러 (함수)를 null로 덮어씌움 (이벤트제거)
  test1a.onclick=null;
  alert("이벤트 제거됨");
};
...
box3.addEventListener("click",function(){
  ...
  //e.target :이벤트가 발생한 요소==this==e.target
